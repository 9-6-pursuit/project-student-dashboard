    ...
    <>
        <div className="container card flex-row student-card">
            ...
            <div className="card-body student-info-container">
                <h3 className="card-title h3">{student.names.preferredName} {student.names.middleName.charAt(0)}. {student.names.surname}</h3>
                <p className="card-text mt-n3">{student.username}</p>
